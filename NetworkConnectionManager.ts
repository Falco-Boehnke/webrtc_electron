export class NetworkConnectionManager {
    ...
    {
        let val = document.getElementById('msgInput').textContent;
    ...
    getUrlAndCreateConnection() {
        let url = document.getElementById('signaling_uri').textContent;
    ...
    userNameAndSend() {
        let username = document.getElementById('login_name').textContent;
        this.send({
            type: "login",
            userName: username
        });
