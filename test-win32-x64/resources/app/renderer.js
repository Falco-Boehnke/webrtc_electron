...
function handleLogin(success){
    ...
    else(success == true)
    {
        ...
        // dataChannel = localConn.createDataChannel("testchannel", {reliable:true});

        // // Creating datachannel
        // dataChannel = localConn.createDataChannel("testchannel", {reliable: true});
        //  dataChannel.onerror = function(error){
        //      console.log("Error with the datachannel: " + error);
        //  }
        //  // Message handling for datachannel (vastly different from websocket)
